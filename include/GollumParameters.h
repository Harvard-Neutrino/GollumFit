...
struct SteeringParams {
  ...
  std::string neodansaFluxDir;                      ///< Directory of GollumFit's shipped nuSQuIDS flux tables (astro.hdf5, atmospheric.hdf5, 16 daemonflux gradient tables) used to build the native NeoDANSA caches
