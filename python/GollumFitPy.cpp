...
PYBIND11_MODULE(GollumFitPy, m)
{
  ...
  py::class_<GF::SteeringParams ,std::shared_ptr<GF::SteeringParams> >(m, "SteeringParams")
    ...
    .def_readwrite("minRA",&GF::SteeringParams::minRA)
    .def_readwrite("maxRA",&GF::SteeringParams::maxRA)
    .def_readwrite("raBinEdge",&GF::SteeringParams::raBinEdge)
    .def_readwrite("raBinWidth",&GF::SteeringParams::raBinWidth)
    .def_readwrite("useNeoDANSAWeighter",&GF::SteeringParams::useNeoDANSAWeighter)
    .def_readwrite("interaction",&GF::SteeringParams::interaction)
    .def_readwrite("gammaAstro",&GF::SteeringParams::gammaAstro)
    .def_readwrite("gammaGalactic",&GF::SteeringParams::gammaGalactic)
    .def_readwrite("neodansaExposure",&GF::SteeringParams::neodansaExposure)
    .def_readwrite("neodansaFluxDir",&GF::SteeringParams::neodansaFluxDir)
  ...
  py::class_<GF::FitParameters, std::shared_ptr<GF::FitParameters> >(m, "FitParameters")
    ...
    .def_readwrite("g",&GF::FitParameters::g)
    .def_readwrite("mphi",&GF::FitParameters::mphi)
    .def_readwrite("mx",&GF::FitParameters::mx)
    .def_readwrite("normGalactic",&GF::FitParameters::normGalactic)
    .def_readwrite("muonNorm",&GF::FitParameters::muonNorm)
  ;
  ...
  py::class_<GF::FitParametersBound, std::shared_ptr<GF::FitParametersBound> >(m, "FitParametersBound")
    ...
    .def_readwrite("gMin",&GF::FitParametersBound::gMin)
    .def_readwrite("gMax",&GF::FitParametersBound::gMax)
    .def_readwrite("mphiMin",&GF::FitParametersBound::mphiMin)
    .def_readwrite("mphiMax",&GF::FitParametersBound::mphiMax)
    .def_readwrite("mxMin",&GF::FitParametersBound::mxMin)
    .def_readwrite("mxMax",&GF::FitParametersBound::mxMax)
    .def_readwrite("normGalacticMin",&GF::FitParametersBound::normGalacticMin)
    .def_readwrite("normGalacticMax",&GF::FitParametersBound::normGalacticMax)
    .def_readwrite("muonNormMin",&GF::FitParametersBound::muonNormMin)
    .def_readwrite("muonNormMax",&GF::FitParametersBound::muonNormMax)
  ;
  ...
  py::class_<GF::FitParametersFlag, std::shared_ptr<GF::FitParametersFlag> >(m, "FitParametersFlag")
    ...
    .def_readwrite("g",&GF::FitParametersFlag::g)
    .def_readwrite("mphi",&GF::FitParametersFlag::mphi)
    .def_readwrite("mx",&GF::FitParametersFlag::mx)
    .def_readwrite("normGalactic",&GF::FitParametersFlag::normGalactic)
    .def_readwrite("muonNorm",&GF::FitParametersFlag::muonNorm)
  ;
  ...
  py::class_<GF::Priors, std::shared_ptr<GF::Priors> >(m, "Priors")
    ...
    .def_readwrite("gWidth",&GF::Priors::gWidth)
    .def_readwrite("gCenter",&GF::Priors::gCenter)
    .def_readwrite("mphiWidth",&GF::Priors::mphiWidth)
    .def_readwrite("mphiCenter",&GF::Priors::mphiCenter)
    .def_readwrite("mxWidth",&GF::Priors::mxWidth)
    .def_readwrite("mxCenter",&GF::Priors::mxCenter)
    .def_readwrite("normGalacticWidth",&GF::Priors::normGalacticWidth)
    .def_readwrite("normGalacticCenter",&GF::Priors::normGalacticCenter)
    .def_readwrite("muonNormWidth",&GF::Priors::muonNormWidth)
    .def_readwrite("muonNormCenter",&GF::Priors::muonNormCenter)
 ...
 ;
  ...
  py::class_<GF::GollumFit, std::shared_ptr<GF::GollumFit> >(m, "GollumFit")
    ...
    .def("LoadNeoDANSAMC", &GF::GollumFit::LoadNeoDANSAMC)
    .def("LoadNeoDANSABackground", &GF::GollumFit::LoadNeoDANSABackground)
    .def("NumMCEvents", &GF::GollumFit::NumMCEvents)
    .def("GetExpectationComponent", &GF::GollumFit::GetExpectationComponent)
